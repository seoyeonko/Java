...
public class CategoryManageDialog extends JDialog {
	...
	private void buildGUI() {
		...
		/*
		 * SiteCategoryList items = new SiteCategoryList(); items.addList(sc1);
		 * items.addList(sc2); items.addList(sc3);
		 */
		// v = items.toVector();
		list = new JList<SiteCategory>(SiteInfoManager.v);
	...
	private void registerListener() {
		...
		bDel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				SiteInfoManager.v.remove(idx);
				SiteInfoManager.v2.remove(idx);
		...
		bAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				String s = f.getText();
				SiteInfoManager.v.add(new SiteCategory(s));
				SiteInfoManager.v2.add(new SiteCategory(s));
