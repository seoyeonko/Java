...
public class SiteInfoManager extends JFrame {
	...
	SiteCategoryList list = new SiteCategoryList();
	Vector<SiteCategory> v = new Vector<SiteCategory>();
	Vector<SiteCategory> v2 = new Vector<SiteCategory>();
	...
	private void createMenu() {
		...
		mItem2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				CategoryManageDialog dlg = new CategoryManageDialog(SiteInfoManager.this, list, v, v2);
				dlg.setVisible(true);
		...
		fItem3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					OutputStream output = new FileOutputStream("./TableInfo.txt");
				...
				try {
					OutputStream output2 = new FileOutputStream("./Category.txt");
		...
		sItem1.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				try {
					output = new FileOutputStream("./AutoLogin.txt");
				} catch (FileNotFoundException e1) {
					e1.printStackTrace();
				}
...
//      p.setLayout(new BoxLayout(p, BoxLayout.Y_AXIS)); // 수직 정렬 **
	...
	private JComponent RigiStatusTab() {
		...
		can = new GraphCanvas(siteInfoList, v);
		return can;
